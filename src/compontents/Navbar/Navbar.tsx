                ...
                <Nav className="me-auto" style={{ position: 'absolute', right: 100 }}>
                    ...
                    <Nav.Link to={'/about'} as={NavLink}>
                        ...
                        <NavDropdown title="Clinic" id="clinic-dropdown">
                            <NavDropdown.Item as={NavLink} to="/clinic/add_drug">
                                Add drug
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/delete_drug">
                                Delete drug
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/show_all_drugs">
                                Show all drugs
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/update_drug">
                                Update
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/add_presc">
                                Add prescription
                            </NavDropdown.Item><NavDropdown.Item as={NavLink} to="/clinic/delete_presc">
                                Delete prescription
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/show_presc">
                                Show all prescriptions
                            </NavDropdown.Item>
                            <NavDropdown.Item as={NavLink} to="/clinic/show_presc_id">
